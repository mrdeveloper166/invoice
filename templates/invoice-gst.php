  ...
  <div class="invoice-wrap">
    ...
    <div class="party-row">
      <div class="party-col">
        ...
        <?php if(!empty($data['gstin'])){ ?>
          <div class="muted"><b>GSTIN:</b> <?php echo $data['gstin']; ?></div>
        <?php } ?>
      ...
      <div class="party-col">
        <div class="label-heading">Supply &amp; Terms</div>
        <div class="muted">
          <b>Place of Supply:</b> <?php echo $data['place_of_supply']; ?><br>
          <?php if(!empty($data['state'])){ ?>
            <b>Client State:</b> <?php echo $data['state']; ?><br>
          <?php } ?>
          <b>Payment Terms:</b> <?php echo $data['payment_terms']; ?><br>
          <?php if(!empty($data['due_date'])){ ?>
            <b>Due Date:</b> <?php echo $data['due_date']; ?>
          <?php } ?>
        </div>
      </div>
    </div>
      ...
      <tbody>
        <?php foreach($items_arr as $item){ ?>
          <tr>
            ...
            <td class="text-right"><?php echo formatMoney($item['unit_price'], 'INR'); ?></td>
            <td class="text-right"><?php echo formatMoney($item['amount'], 'INR'); ?></td>
          </tr>
        <?php } ?>
      </tbody>
    </table>
    ...
    <div class="totals-wrap">
      <table class="summary">
        <tr>
          <th>Subtotal</th>
          <td><?php echo formatMoney($data['subtotal'], 'INR'); ?></td>
        </tr>
        <tr>
          <th>CGST (9%)</th>
          <td><?php echo formatMoney($data['cgst'] ?? 0, 'INR'); ?></td>
        </tr>
        <tr>
          <th>SGST (9%)</th>
          <td><?php echo formatMoney($data['sgst'] ?? 0, 'INR'); ?></td>
        </tr>
        <tr>
          <th>IGST (18%)</th>
          <td><?php echo formatMoney($data['igst'] ?? 0, 'INR'); ?></td>
        </tr>
        <tr class="grand">
          <th>Grand Total</th>
          <td><?php echo formatMoney($data['grand_total'], 'INR'); ?></td>
        </tr>
      </table>
    </div>
